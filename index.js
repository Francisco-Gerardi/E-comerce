    ...
    array.forEach(item => {
        ...
        div.innerHTML += `
                <div class="articleDivProductos">
                    <h3 class="articleTituloProductos">${item.nombre}</h3>
...
function agregarAlCarrito(id) {
    ...
    if (actualizarNumero) {
        ...
        document.getElementById(`und${actualizarNumero.id}`).innerHTML =
            `<p id="und${actualizarNumero.id}">Unidades:${actualizarNumero.cantidad}</p>`
        actualizarCarrito()
    } else {
    ...
    div.innerHTML = `
            ...
            <div class="carritoModalProductos ">
                ...
                <div class="carritoModalTodo">
                    <p class="carritoModalProductoNombre">${productoAgregar.nombre}</p>
                    <div class="carritoModalProductoPrecio">
                        <p class="carritoModalLetra" id="und${productoAgregar.id}">Unidades: ${productoAgregar.cantidad}</p>
...
function filtros(tipodefiltro) {
    tipodefiltro.addEventListener("click", () => {
        if (tipodefiltro.value == "todos") {
            ...
            mostrarProductos(stockProductos.filter(elemento => elemento.estilo == tipodefiltro.value))
        }
